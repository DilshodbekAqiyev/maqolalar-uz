...
export const Sidebar = () => {
  ...
  const onCreateDocument = () => {
    ...
    toast.promise(promise, {
      loading: "Yangi hujjat yaratilmoqda…",
      success: "Yangi hujjat yaratildi!",
      error: "Yangi hujjat yaratib bo‘lmadi",
    });
  };
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          />
          <Item label="Yangi hujjat" icon={Plus} onClick={onCreateDocument} />
        </div>
        ...
        <div className="mt-4">
          ...
          <Item
            ...
            icon={Plus}
            label="Sahifa qo'shish"
          />

          <Popover>
            <PopoverTrigger className="w-full mt-4">
              <Item label="Chiqitdon" icon={Trash} />
            </PopoverTrigger>
            <PopoverContent
              className="p-0 w-72"
            ...
            <>
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-1 text-[13px]">
                  <Rocket />
                  <p className="opacity-70 font-bold">{plan} reja</p>
                </div>
                {plan === "Free" ? (
